...
/**
 * Airpants, Lisa Greenleaf — duple improper.
 *
 * Source: The Caller's Box dance 4577
 ...
 * B2  (6) Circle left 3/4   (10) Neighbor do-si-do 1 & 1/2
 * ```
 */
export const airpants: Dance = contraDance({
  slug: "airpants",
  title: "Airpants",
  author: "Lisa Greenleaf",
  formation: DUPLE_IMPROPER,
  notes: "The Caller's Box 4577, permission: full.",
  phrases: [
    {
      name: "A1",
      figures: [
    ...
    },
    {
      ...
      figures: [
        ...
        },
        {
          figure: "do-si-do",
          beats: 10,
          params: { pairs: "neighbors", amount: 1.5 },
          call: "NEIGHBOR DO-SI-DO ONE AND A HALF",
        },
      ],
    },
  ],
